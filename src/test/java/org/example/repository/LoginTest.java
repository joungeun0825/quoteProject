...
public class LoginTest {
    ...
    public Map getUsernamePasswordMap(String username, String password) {
    ...
    public ResultActions perform(String url, MediaType mediaType, Map usernamePasswordMap) throws Exception {
