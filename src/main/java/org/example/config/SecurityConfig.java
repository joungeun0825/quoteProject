...
import org.example.config.login.filter.JsonUsernamePasswordAuthenticationFilter;
import org.example.config.login.filter.JwtAuthenticationProcessingFilter;
import org.example.config.login.handler.LoginFailureHandler;
import org.example.config.login.handler.LoginSuccessJWTProvideHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .requestMatchers("/login", "/signUp","/","/api/books").permitAll()
